...
## View es para ver dentro de RStudio (sólo funciona)
...
# Mascara es un concepto basntate amplio que en este contexto
...
# Podemos combinar sintáxisis. Aquí estamos primero cogiendo
...
colnames() # Muestra los nombres de columnas
rownames()# de filas 
