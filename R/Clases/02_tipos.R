...
# Las listas pueden contener otras listas. Por eso p.e. se usan
# para representar los datos recogidos de un JSON en R
# O estructuras de datos poco estructuradas
data <- list(a=1,b=list(k=5 ))
