...
amazon <- as.vector(bolsa$AMZN.Open)
google <- as.vector(bolsa$GOOGL.Open)
puntos <- puntosDeCompra(amazon, google)
...
puntos <- puntosDeCompra(amazon, google)
puntos <- puntosDeCompra(bolsa$AMZN.Open, bolsa$GOOGL.Open)
...
backtesting(bolsa$AMZN.Open, bolsa$GOOGL.Open, puntosDeCompra(bolsa$AMZN.Open, bolsa$GOOGL.Open))
